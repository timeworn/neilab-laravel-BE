                        ...
                        <div class="row justify-content-between align-items-center gutter-vr-40px">
                            <div class="col-lg-6 order-lg-last">
                                <div class="gfx py-4 animated" data-animate="fadeInUp" data-delay="0.2">
                                    <img src="/front/images/azalea/gfx-e.png" alt="gfx">
                                </div>
                            </div>
                            <div class="col-lg-5">
                ...
                <div class="container container-xxl">
                    <div class="nk-block">
                        ...
                        <div class="bg-image bg-contain bg-bottom-center bg-ecosystems animated d-none d-sm-block" data-animate="fadeInUp" data-delay="0.2">
                            <img src="/front/images/globe-particle.png" alt="globe">
                        </div>
                    </div>
                </div>
            </section>
                                ...
                                <div class="row align-items-center justify-content-between gutter-vr-40px">
                                    <div class="col-lg-6 order-lg-last">
                                        <div class="nk-block-img nk-block-ca animated" data-animate="fadeInUp" data-delay="0.2">
                                            ...
                                            <img class="shadow rounded" src="/front/images/app-screens/sc-medium-a.png" alt="">
                                        </div>
                                    </div>
                                    <div class="col-lg-5">
                        ...
                        <div class="row align-items-center justify-content-center justify-content-xl-between gutter-vr-30px">
                            <div class="col-xxl-6 col-xl-6 col-lg-8">
                                <div class="nk-block-img nk-block-plx animated" data-animate="fadeInUp" data-delay="0.3">
                                    <img class="shadow rounded" src="/front/images/app-screens/sc-medium-b.png" alt="">
                                    <img class="nk-block-img-plx plx-screen shadow rounded" src="/front/images/app-screens/sc-small-d.jpg" alt="">
                                    <img class="nk-block-img-plx plx-circle plx-circle-s1" src="/front/images/gfx/circle-a.png" alt="">
                                    <img class="nk-block-img-plx plx-polygon plx-polygon-s1" src="/front/images/gfx/polygon-a.png" alt="">
                                    <img class="nk-block-img-plx plx-triangle plx-triangle-s1" src="/front/images/gfx/triangle-a.png" alt="">
                                </div>
                            </div>
                        ...
                        <div class="has-carousel carousel-nav-center" data-items="4" data-navs="true">
                            <div class="item animated" data-animate="fadeInUp" data-delay="0.3">
                                <div class="team team-s2 team-odd">
                                    <div class="team-photo team-photo-s2">
                                        <img src="/front/images/azalea/team-a.jpg" alt="">
                                    ...
                                    <div class="row align-items-start">
                                        <div class="col-md-6">
                                            <div class="team-photo">
                                                <img src="/front/images/azalea/team-a.jpg" alt="team">
                                            </div>
                                        </div><!-- .col  -->
                                        <div class="col-md-6">
                            ...
                            <div class="item animated" data-animate="fadeInUp" data-delay="0.4">
                                <div class="team team-s2 team-even">
                                    <div class="team-photo team-photo-s2">
                                        <img src="/front/images/azalea/team-b.jpg" alt="">
                                ...
                                <div id="team-popup-2" class="team-popup bg-theme-dark tc-light mfp-hide">
                                    ...
                                    <div class="row align-items-start">
                                        <div class="col-md-6">
                                            <div class="team-photo">
                                                <img src="/front/images/azalea/team-b.jpg" alt="team">
                                            </div>
                                        </div><!-- .col  -->
                                        <div class="col-md-6">
                                            <div class="team-popup-info ps-md-3">
                            ...
                            <div class="item animated" data-animate="fadeInUp" data-delay="0.5">
                                <div class="team team-s2 team-odd">
                                    <div class="team-photo team-photo-s2">
                                        <img src="/front/images/azalea/team-c.jpg" alt="">
                                ...
                                <div id="team-popup-3" class="team-popup bg-theme-dark tc-light mfp-hide">
                                    ...
                                    <div class="row align-items-start">
                                        <div class="col-md-6">
                                            <div class="team-photo">
                                                <img src="/front/images/azalea/team-c.jpg" alt="team">
                                            </div>
                                        </div><!-- .col  -->
                                        <div class="col-md-6">
                                            <div class="team-popup-info ps-md-3">
                            ...
                            <div class="item animated" data-animate="fadeInUp" data-delay="0.6">
                                <div class="team team-s2 team-even">
                                    <div class="team-photo team-photo-s2">
                                        <img src="/front/images/azalea/team-d.jpg" alt="">
                                ...
                                <div id="team-popup-4" class="team-popup bg-theme-dark tc-light mfp-hide">
                                    ...
                                    <div class="row align-items-start">
                                        <div class="col-md-6">
                                            <div class="team-photo">
                                                <img src="/front/images/azalea/team-d.jpg" alt="team">
                                            </div>
                                        </div><!-- .col  -->
                                        <div class="col-md-6">
                                            <div class="team-popup-info ps-md-3">
                ...
                <div class="container container-xxl">
                    ...
                    <div class="nk-block block-partners">
                        ...
                        <ul class="has-carousel partner-list justify-content-center animated" data-items="7" data-items-mobile="2" data-auto="true" data-loop="true" data-animate="fadeInUp" data-delay="0.75">
                            <li class="partner-logo"><img src="/front/images/partners/a-light.png" alt=""></li>
                            <li class="partner-logo"><img src="/front/images/partners/b-light.png" alt=""></li>
                            <li class="partner-logo"><img src="/front/images/partners/c-light.png" alt=""></li>
                            <li class="partner-logo"><img src="/front/images/partners/d-light.png" alt=""></li>
                            <li class="partner-logo"><img src="/front/images/partners/e-light.png" alt=""></li>
                            <li class="partner-logo"><img src="/front/images/partners/f-light.png" alt=""></li>
                            <li class="partner-logo"><img src="/front/images/partners/g-light.png" alt=""></li>
                            <li class="partner-logo"><img src="/front/images/partners/a-light.png" alt=""></li>
                            <li class="partner-logo"><img src="/front/images/partners/b-light.png" alt=""></li>
                            <li class="partner-logo"><img src="/front/images/partners/c-light.png" alt=""></li>
                            <li class="partner-logo"><img src="/front/images/partners/d-light.png" alt=""></li>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="doc animated" data-animate="fadeInUp" data-delay="0.3">
                                    <div class="doc-photo doc-shape doc-shape-a">
                                        <img src="/front/images/azalea/doc-a.jpg" alt="">
                                    </div>
                                    <div class="doc-text">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="doc animated" data-animate="fadeInUp" data-delay="0.4">
                                    <div class="doc-photo doc-shape doc-shape-b">
                                        <img src="/front/images/azalea/doc-b.jpg" alt="">
                                    </div>
                                    <div class="doc-text">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="doc animated" data-animate="fadeInUp" data-delay="0.5">
                                    <div class="doc-photo doc-shape doc-shape-c">
                                        <img src="/front/images/azalea/doc-c.jpg" alt="">
                                    </div>
                                    <div class="doc-text">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="doc animated" data-animate="fadeInUp" data-delay="0.6">
                                    <div class="doc-photo doc-shape doc-shape-d">
                                        <img src="/front/images/azalea/doc-d.jpg" alt="">
                                    </div>
                                    <div class="doc-text">
                                        ...
                                        <div class="item pb-2">
                                            <div class="blog blog-s2 animated" data-animate="fadeInUp" data-delay="0.8">
                                                ...
                                                <div class="bg-image round" data-overlay="theme-dark" data-opacity="85">
                                                    <img src="/front/images/azalea/news-hr-a.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="blog blog-s2 animated" data-animate="fadeInUp" data-delay="0.85">
                                                ...
                                                <div class="bg-image round" data-overlay="theme-dark" data-opacity="85">
                                                    <img src="/front/images/azalea/news-hr-b.jpg" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="item pb-2">
